...
<script type="text/javascript">
	...
	function back() {
		window.location.href='<%=request.getContextPath()%>/app/workflow/item/show.jsp?flowId=<%=request.getParameter("flowId")%>';
		return false;
...
<body>
	<div id="panel" class="easyui-panel" title="数据库创建表"
		...
		<form id="editForm"
			action="<%=request.getContextPath()%>/app/workflow/item/createTable.action?flowId=<%=request.getParameter("flowId")%>"
			method="post">
