...
<body>
	<div id="panel" class="easyui-panel" title="修改表单属性"
		...
		<form id="editForm"
			action="<%=request.getContextPath()%>/app/workflow/item/update.action"
			method="post">
			<table class="table-form">
				...
				<tr>
					...
					<td><input id="showName" name="showName" type="text" value="${item.showName}"></input></td>
					<td><div id="showNameTip"></div></td>
				</tr>
				<tr>
					<td style="text-align:right">默认值:</td>
					<td><input id="defaultValue" name="defaultValue" type="text" value="${item.defaultValue}"></input></td>
					<td><div id="defaultValueTip"></div></td>
				</tr>
				<tr>
					<td style="text-align:right">最小长度:</td>
					<td><input id="min" name="min" value="${item.min}"></input></td>
					<td><div id="minTip"></div></td>
				</tr>
				<tr>
					<td style="text-align:right">最大长度:</td>
					<td><input id="max" name="max" value="${item.max}"></input></td>
				...
				<tr>
					...
					<td><input id="focusTip" name="focusTip" value="${item.focusTip}"></input></td>
					<td><div id="focusTipTip"></div></td>
				</tr>
				<tr>
					<td style="text-align:right">验证函数:</td>
					<td><textarea id="func" name="func" cols="70", rows="10">${item.func}</textarea></td>
				...
				<tr>
					...
					<td><textarea id="render" name="render" cols="70", rows="10">${item.render}</textarea></td>
			...
			<input id="regexName" type="hidden" name="regexName" type="text" value="${item.regexName}"></input>
			<input id="typeName" type="hidden" name="typeName" type="text" value="${item.typeName}"></input>
